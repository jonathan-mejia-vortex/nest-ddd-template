...
import type { UserRole } from "../../src/modules/users/domain/entities/user.entity";
import type { PrismaService } from "../../src/shared/infrastructure/persistence/prisma.service";
